...
if __name__ == "__main__":
    # 直接在代码中设置参数
    input_file = "dapeng_s_pointcloud/dapeng_1/semantic_fused.ply"
    output_file = "dapeng1_occupancy_grid.csv"
    color_output_file = "dapeng1_color_grid.csv"
    resolution = 0.05  # 栅格分辨率(米)
    z_min = -1.0  # Z轴最小值(米)
    z_max = 1.0  # Z轴最大值(米)
    threshold = 0.5  # 占据概率阈值
    normal = [-0.0264859, 0.716002, 0.697703]  # 指定新xy平面的法向量
