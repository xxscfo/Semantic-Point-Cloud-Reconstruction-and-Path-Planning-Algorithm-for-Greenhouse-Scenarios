...
public:
    ...
    cv::Mat mImGray;
    cv::Mat mImRGB;//添加以显示彩色点云
    cv::Mat mImDepth; // 深度用于生成点云adding mImDepth member to realize pointcloud view
...
protected:
    ...
    shared_ptr<PointCloudMapping> mpPointCloudMapping;//用于pointcloud显示
